  ...
  <h1 style='text-align: center'>
    <?php
        ...
        try {
            ...
            if ($renglones==1) {
              echo "Producto: ".$result["producto_nombre"]."<br>"."<br>";
              echo "Precio: ".$result["producto_precio"]."<br>"."<br>";
              echo "Stock: ".$result["producto_stock"]."<br>"."<br>";
              echo "<img src='".$result["producto_imagen"]."' width='200px' height='200px'>";
            }
            else{
